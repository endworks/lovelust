...
struct StatusLiveActivity_Previews: PreviewProvider {
    static let attributes = StatusAttributes(name: "Me")
    static let contentState = StatusAttributes.ContentState(value: 3)
